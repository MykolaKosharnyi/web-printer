...
<body>
			...
			<ul id="sortable">
				<c:forEach items="${listPictures.fileNameArray}" var="namePicture">
					<li class="ui-state-default" id="${namePicture}">
						...
						<img src="/images/home/three_big_pictures/${directory}/${subDirectory}/${namePicture}" alt="">
					</li>
				</c:forEach>
			</ul>
		</div>
      ...
      $(function() {
    	$('#sortable').sortable({
    		update: function(event, ui) {
    			...
    			$.ajax({
    				  type: 'POST',
    				  url: "/admin/pictures/three_big_pictures/${directory}/${subDirectory}/change_order_pictures",
    				  data: data,
    ...
    $(document).on('click', '.delete_img', function(){
    	...
    	$.ajax({
    		  type: 'POST',
    		  url: "/admin/pictures/three_big_pictures/${directory}/${subDirectory}/remove_picture/" + $(this).closest('li').attr('id').replace(".", ":"),
    		  contentType: "application/json; charset=utf-8",
              dataType: "json"
    		  });	
