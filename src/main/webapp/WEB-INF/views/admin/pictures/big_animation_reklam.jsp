...
<head>
	<style>
  		#sortable { list-style-type: none; margin: 0; padding: 0; width: 1000px; height: auto;}
  		...
  		#sortable li img{ width: 930px ; height:450px; margin: 0px 5px 5px 5px; }
  	</style>
	...
	<title>
		<spring:message text="Редактирование содержимого анимированной рекламы " />
	</title>
</head>
<body>
	<c:url var="addPictures" value="/admin/pictures/central_reklam/upload_pictures" ></c:url>
	...
	<div id="product">
		...
		<div id="pictures">
			...
			<ul id="sortable">
				<c:forEach items="${listPictures}" var="namePicture">
					<li class="ui-state-default" id="${namePicture}">
						<div>
							<p class="delete_img">Удалить</p>
						</div>
						<img src="/images/home/big_reklam/${namePicture}" alt="">
					</li>
				</c:forEach>
			</ul>
		</div>
      ...
      $(function() {
    	$('#sortable').sortable({
    		update: function(event, ui) {
    			...
    			$.ajax({
    				  type: 'POST',
    				  url: "/admin/pictures/central_reklam/change_order_pictures",
    				  data: data,
    ...
    $(document).on('click', '.delete_img', function(){
    	...
    	$.ajax({
    		  type: 'POST',
    		  url: "/admin/pictures/central_reklam/remove_picture/" + $(this).closest('li').attr('id').replace(".", ":"),
    		  contentType: "application/json; charset=utf-8",
              dataType: "json"
    		  });	
