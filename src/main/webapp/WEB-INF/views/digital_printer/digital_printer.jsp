...
<a class="fancybox" data-fancybox-group="group" href="/images/digital_printers/${product.id}/${product.pathPictures.get(0)}">
<img src="/images/digital_printers/${product.id}/${product.pathPictures.get(0)}" alt="alt" /></a>
						...
						<div class="row">
							<div class="small_pictures">
								<c:forEach items="${product.pathPictures}" var="pathPicture">
									<a class="fancybox" data-fancybox-group="group" href="/images/digital_printers/${product.id}/${pathPicture}">
<img src="/images/digital_printers/${product.id}/${pathPicture}" alt="alt" /></a>
								</c:forEach>
							</div>
						</div>
					</div>
