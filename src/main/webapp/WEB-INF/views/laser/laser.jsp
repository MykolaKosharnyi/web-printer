...
<a class="fancybox" data-fancybox-group="group" href="/images/lasers/${product.id}/${product.pathPictures.get(0)}">
<img src="/images/lasers/${product.id}/${product.pathPictures.get(0)}" alt="alt" /></a>
						...
						<div class="row">
							<div class="small_pictures">
								<c:forEach items="${product.pathPictures}" var="pathPicture">
									<a class="fancybox" data-fancybox-group="group" href="/images/lasers/${product.id}/${pathPicture}">
<img src="/images/lasers/${product.id}/${pathPicture}" alt="alt" /></a>
								</c:forEach>
							</div>
						</div>
					</div>
