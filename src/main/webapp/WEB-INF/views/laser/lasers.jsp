...
<div id="out_result_of_search">
	<c:forEach items="${listProducts}" var="product">
		<div class="products">
			<a id="/images/lasers/${product.id}/${product.pathPictures.get(1)}" class="link" href="<c:url value='/laser/${product.id}' />">	
					<div class="outer_a_img"><img src="/images/lasers/${product.id}/${product.pathPictures.get(0)}" alt=""></div>
			</a>
			<a href="javascript:void(0)" onclick="addToCart('laser', ${product.id});" class="products_buy">
				<img src="/images/button_buy.png" alt="" />
			</a>
			<a href="<c:url value='/laser/${product.id}' />" class="products_title">${product.name}</a>
