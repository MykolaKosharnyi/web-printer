...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	 <div id="out_result_of_search">
            <c:forEach items="${listProducts}" var="product">
            	<a href="<c:url value='/printer_3d/${product.id}' />" class="products">
				    <div class="products_image"><img src="<%=request.getContextPath()%>/resources/images/printers3d/${product.id}/${product.pathPictures.get(0)}" alt=""></div>
