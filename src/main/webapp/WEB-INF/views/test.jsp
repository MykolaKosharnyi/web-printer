...
<body>
	...
	<c:url var="addAction" value="/printers/searching" ></c:url>
	<form:form modelAttribute="searchPrintersCriteria" action="${addAction}">
...
<!-- 					<div>
		...
		<div class="search_criteria">
			...
			<ul class="check_boxes">
				<div class="text_output">
					<form:input path="speedPrint0" class="amount-speed-print0" value="0"/>
					<p>&nbsp;м.кв./ч. -&nbsp;</p>
		...
		<div class="search_criteria">
			...
			<ul class="check_boxes">
				<div class="text_output">
					<form:input path="maximumMediaThickness60_0" class="amount-maximum_media_thickness60_0" value="0"/>
					<p>&nbsp;мм -&nbsp;</p>
					<form:input path="maximumMediaThickness60_1" class="amount-maximum_media_thickness60_1" value="60"/>
					<p>&nbsp;мм</p>
				</div>
				<div class="slider">
				...
				<br>
				<div class="text_output">
					<form:input path="maximumMediaThickness500_0" class="amount-maximum_media_thickness500_0" value="60"/>
					<p>&nbsp;мм -&nbsp;</p>
					<form:input path="maximumMediaThickness500_1" class="amount-maximum_media_thickness500_1" value="500"/>
					<p>&nbsp;мм</p>
				</div>
				<div class="slider">
		...
		<div class="search_criteria">
			...
			<ul class="check_boxes">
				<div class="text_output">
					<form:input path="maximumWeightOfVehicle0" class="amount-maximum_weight_of_vehicle0" value="5"/>
					<p>&nbsp;кг -&nbsp;</p>
					<form:input path="maximumWeightOfVehicle1" class="amount-maximum_weight_of_vehicle1" value="500"/>
					<p>&nbsp;кг</p>
				</div>
				<div class="slider">
		...
		<div class="search_criteria">
			...
			<ul class="check_boxes">
				<div class="text_output">
					<form:input path="maxPowerConsumption0" class="amount-max_power_consumption0" value="1"/>
					<p>&nbsp;кВт -&nbsp;</p>
					<form:input path="maxPowerConsumption1" class="amount-max_power_consumption1" value="100"/>
					<p>&nbsp;кВт</p>
				</div>
				<div class="slider">
