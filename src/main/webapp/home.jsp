                     ...
                     <div class="slide-list6">
                         <div class="slide-wrap6">
                            <div class="slide-item6">
                                <div class="slider_image"><<%=request.getContextPath()%>/resources/img src="img/1.png" alt="" /></div>
                           ...
                           <div class="slide-item6">
                                <div class="slider_image"><<%=request.getContextPath()%>/resources/img src="img/2.png" alt="" /></div>
                                <div class="slide-title6">Name of product: </div>
                                <div class="slide-price6">Prise: </div>
                                <input class="slide-buy6" type="button" value="Добавить в корзину" >
                            </div>
                            ...
                            <div class="slide-item6">
                                <div class="slider_image"><<%=request.getContextPath()%>/resources/img src="img/3.png" alt="" /></div>
                                <div class="slide-title6">Name of product: </div>
                                <div class="slide-price6">Prise: </div>
                                <input class="slide-buy6" type="button" value="Добавить в корзину" >
                            </div>
