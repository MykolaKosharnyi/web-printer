...
public class FileController {
         ...
         while(itr.hasNext()){
             ...
             try {
                fileMeta.setBytes(mpf.getBytes());
                 ...
                 FileCopyUtils.copy(mpf.getBytes(), new FileOutputStream("C:/Users/Николай/Desktop/f/"+mpf.getOriginalFilename()));
    ...
    @RequestMapping(value = "/get/{value}", method = RequestMethod.GET)
     public void get(HttpServletResponse response,@PathVariable String value){
	  ...
	  public void get1(HttpServletResponse response,@PathVariable String value){
	        try {
